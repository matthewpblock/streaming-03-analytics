...
def load_reference_data() -> set[str]:
    ...
    Load NBA player data to validate active player IDs.

    Returns:
        A set of valid_player_ids.
...
def send_messages(
    ...
    Arguments:
        ...
        valid_player_ids: Set of known player IDs for validation.
...
def main() -> None:
    ...
    valid_player_ids = load_reference_data()
    ...
    initialize_output()
    sent_count, rejected_count = send_messages(producer, settings, valid_player_ids)
